...
export default function RegisterPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#0D0D0D] px-4">
            ...
            <p className="text-gray-500 mb-8 font-bold tracking-widest text-sm uppercase">Dołącz do stawki</p>

            <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
                <div>
                    <input
                        type="text"
                        placeholder="Imię kierowcy (Nazwa wyświetlana)"
                        value={name}
                ...
                <div>
                    <input
                        type="text"
                        placeholder="Nazwa zespołu (Opcjonalnie)"
                        value={team}
                ...
                >
                    {loading ? "Uruchamianie silnika..." : "Uruchom silnik"}
                </button>
